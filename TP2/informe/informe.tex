...
Con el fin de relevar la diferencia en costos, generamos $?$ instancias de los dos tipos de distribuciones y evaluamos cada una con las cuatro metodologías distintas. 
En la figura $?$ se muestran los resultados donde, como era esperable para las instancias con clusters, cualquier metodología con repartidores en general va a tener un menor costo de reparto que la metodología actual. 
